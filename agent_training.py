...
class Group30Player_training(BasePokerPlayer):
    RAISE_INDEX = 2
    CALL_INDEX = 1
    FOLD_INDEX = 0
    player_types = {
    ...
    def __findTableType(self, street):
        ...
        if winrate_at_street <= Group30Player_training.winrate_ceiling_for_table_0:
            return 0
        elif winrate_at_street <= Group30Player_training.winrate_ceiling_for_table_1:
            return 1
        elif winrate_at_street <= Group30Player_training.winrate_ceiling_for_table_2:
            return 2
        else:
            return 3
    ...
    def __get_ordered_action_list(self, valid_actions):
        ...
        for i in valid_actions:
            if i["action"] == "raise":
                action_index_list[Group30Player_training.RAISE_INDEX] = i
            if i["action"] == "call":
                action_index_list[Group30Player_training.CALL_INDEX] = i
            else:
                action_index_list[Group30Player_training.FOLD_INDEX] = i
    ...
    def __get_raise_action(self, valid_actions):
        ...
        action_info = action_index_list[Group30Player_training.RAISE_INDEX]
        if action_info != -1:
    ...
    def __get_call_action(self, valid_actions):
        action_index_list = self.__get_ordered_action_list(valid_actions)
        action_info = action_index_list[Group30Player_training.CALL_INDEX]
        if action_info != -1:
            return action_info["action"]
        return None
    ...
    def __get_fold_action(self, valid_actions):
        action_index_list = self.__get_ordered_action_list(valid_actions)
        action_info = action_index_list[Group30Player_training.FOLD_INDEX]
        if action_info != -1:
            return action_info["action"]
        return None
